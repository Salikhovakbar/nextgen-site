...
const Registration = () => {
    const [language,setLanguage] = useState(["Ro'yxatdan o'tish",'Ismingiz','Familiyangiz', 'Yuborish'])
...
ENGLISH SCHOOL</h1>
    ...
    <div>
    <p className='title-text'>{language[0]}</p>
    </div>
    <div>
...
<input type="text" value={firstname} onInput={(e) => {
...
<button className='submit-btn'>{language[3]}</button>
</form>
    </div>
    <div>
    <div className='languages-box'>
        <div style={count === 1 ? {background: '#dae6ff'}: null} onClick={() => {
            setLanguage(['Registration', "First name", 'Last name', 'Send'])
            setCount(1)
        }} className='english-box'>
<img src="https://cambridgeonline.uz/_nuxt/img/en.080efcd.png" alt="" /><span>English</span>
        </div>
        <div style={count === 2 ? {background: '#dae6ff'}: null} onClick={() => {
            setLanguage(["Ro'yxatdan o'tish",'Ismingiz','Familiyangiz', 'Yuborish'])
            setCount(2)
        }} className='uzbek-box'>
<img src="data:image/png;base64," alt="" /><span>Uzbek</span>
        </div>
        <div style={count === 3 ? {background: '#dae6ff'}: null} onClick={() => {
            setLanguage(['Регистрация', "Имя", 'Фамилия', 'Отправить'])
            setCount(3)
        }} className='russian-box'>
        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB8AAAAeCAYAAADU8sWcAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAABQSURBVHgB7daxDcAgDERRO2KOlGnCPCzKLDS0jECNgCXQSej/BV5jWedzZ6IeEwYODn4/7l/Ksg8XauumioMDB78fD3E0U+XlfxmQ4ODgx1qYaQ1B+OJNQgAAAABJRU5ErkJggg==" alt="" />   <span>Russia</span>
        </div>
    </div>
    </div>
    </div>    
